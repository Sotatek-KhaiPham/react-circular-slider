...
const CircularSlider = React.forwardRef(
  (
    {
      label = "ANGLE",
      width = 280,
    ...
    useImperativeHandle(ref, () => circularSlider);
    ...
    const onMouseMove = useCallback(
      (event) => {
        ...
        const offsetRelativeToDocument = (ref_offset) => {
          const rect = ref_offset.current.getBoundingClientRect();
          const scrollLeft =
            !isServer &&
